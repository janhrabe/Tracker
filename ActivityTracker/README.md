...
To update the database use this command from the Web project folder (replace `ActivityTracker` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../ActivityTracker.Infrastructure/ActivityTracker.Infrastructure.csproj -s ActivityTracker.Web.csproj
```
